...
import { useGetCryptoNewsQuery } from '../services/cryptoNewsRapidApi';
...
const News = ({ featured }) => {
    ...
    const { data: cryptoNews } = useGetCryptoNewsQuery({ newsCategory , count: featured ? 6 : 100 });
    const { data } = useGetCryptosQuery(100);

    console.log("cryptoNews",cryptoNews);
    console.log("useGetCryptosQuery",useGetCryptosQuery);

    // Load Spinner till data is returned
